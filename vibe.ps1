...
HARD STOP 5 — PROVE IT: Before writing "done" or "working" anywhere, test with Playwright.
  No Playwright test = write "untested" instead of "done".

HARD STOP 6 — CONTEXT CHECK: After every 5th feature, run git log and update TASKS.md from facts, not memory.
